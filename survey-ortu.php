...
if(isset($_POST['ortu'])) {
  ...
  $data = [
    ...
    "responden_jk" => $_POST['jk'],
    "responden_umur" => $_POST['umur'],
    "responden_hp" => $_POST['hp'],
    "responden_pendidikan" => $_POST['pendidikan'],
    "responden_pekerjaan" => $_POST['pekerjaan'],
    "responden_penghasilan" => $_POST['penghasilan'],
    "mahasiswa_nim" => $_POST['nim'],
    "mahasiswa_nama" => $_POST['namaMHS'],
    "mahasiswa_prodi" => $_POST['prodi']
  ];

  $inserdata = $biodata->insertBiodata("ortu", $data);
...
if (isset($_GET['submit'])) {
  ...
  if($responden->insertData("ortu", $dataTemporary)){
    echo "<script>
alert('Data kamu berhasil kami simpan!');
              window.location = 'biodata.php?kategori=ortu';
</script>";
  }
...
<head>
  ...
  <title>Survey Polinema | Orang  Tua Mahasiswa</title>
    ...
    <section class="content">
      <div class="card">
        <div class="card-header bg-primary">
          <h3 class="card-title font-weight-bold">Form Survey Orang Tua</h3>
        </div>
        <?php
        if (isset($_GET['submit'])) {
          ...
          foreach ($soal as $row):
            ...
            <div>
              <p><?= $no . ". " . $row["soal_nama"] ?></p>
                  ...
                  <input type="text" class="d-none" name="responden_ortu_id_<?= $no ?>" value="<?= $row['id_responden'] ?>">
              <?php
