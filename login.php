...
<head>
  ...
  <style>
    .login-page{
    background-image: url('dist/img/bio_polinema.jpg'); /* Ganti dengan path ke gambar kamu */
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="model/koneksiLogin.php" method="post">
        ...
        <div class="input-group mb-3">
          ...
          <div class="col-12 mt-3">
            <a href="homepage_bio.php" class="btn btn-primary btn-block">Isi Survey</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
