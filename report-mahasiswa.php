...
$list_jawaban = $jawaban->getData("mahasiswa");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="report.php">Report</a></li>
              <li class="breadcrumb-item active">Report Mahasiswa</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div>
            ...
            <table class="table d-none">
              ...
              <?php
              $no = 1;
              foreach ($responden->getData("mahasiswa") as $datum):
                ?>
                <tr>
                  <th scope="row"><?= $no ?></th>
                  <td><?= $datum['responden']['responden_nim'] ?></td>
                  <td><?= $datum['responden']['responden_nama'] ?></td>
                  <td><?= $datum['responden']['responden_prodi'] ?></td>
          ...
          <div>
            <div class="d-flex justify-content-between align-items-center jawaban-title" style="cursor: pointer">
              <p class="font-weight-bold">Grafik Responden</p>
              <i class="fas fa-angle-left right" id="icon"></i>
            </div>
            <div class="d-none">
