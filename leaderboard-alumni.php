...
if (isset($_POST['create'])) {
  ...
  if ($survey->createDataSurvey($data)) {
    echo "<script>
          ...
          window.location.href = 'leaderboard-alumni.php';
          </script>";
  }
}
...
<head>
  ...
  <title>Survey Polinema | Orang Tua</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Leaderboard Alumni Mahasiswa</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="leaderboard.php">Leaderboard</a></li>
              <li class="breadcrumb-item active">Leaderboard Alumni Mahasiswa</li>
            </ol>
          </div>
        </div>
      </div>
