                ...
                while($row = $list->fetch_assoc()){
                  echo '<tr>
                      ...
                      <td>
                        ...
                        <a onclick="return confirm(\'Apakah anda yakin menghapus data ini?\')" title="Hapus Data" href="bank_soal_action.php?act=hapus&id='.$row['id_soal'].'" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                      </td>
