...
$list_jawaban = $jawaban->getData("dosen");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Report Dosen</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between align-items-center responden-title" style="cursor: pointer">
            ...
            <table class="table d-none">
              ...
              <?php
              $no = 1;
              foreach ($responden->getData("dosen") as $datum):
              ?>
              <tr>
                <th scope="row"><?= $no ?></th>
                <td><?= $datum['responden']['responden_nip'] ?></td>
