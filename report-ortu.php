...
$list_jawaban = $jawaban->getData("ortu");
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Orang Tua Mahasiswa</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="report.php">Report</a></li>
              <li class="breadcrumb-item active">Report Orang Tua Mahasiswa</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div>
            ...
            <table class="table d-none">
              ...
              <?php
              $no = 1;
              foreach ($responden->getData("ortu") as $datum):
                ?>
                <tr>
                  <th scope="row"><?= $no ?></th>
                  <td><?= $datum['responden']['responden_nama'] ?></td>
                  <td><?= $datum['responden']['survey_nama'] ?></td>
                  <td><?= $datum['responden']['mahasiswa_nim'] ?></td>
                  <td><?= $datum['responden']['mahasiswa_nama'] ?></td>
                  <td>
